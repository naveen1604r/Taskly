...
export default function GoalFilters({
  ...
  const allCategories = Array.from(
    new Set([...goalCategories, ...(availableCategories || [])])
  );
    ...
    <div className="space-y-4 p-4 sm:p-5 rounded-2xl bg-[#11151F] border border-white/[0.08] shadow-subtle">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="relative flex items-center">
            ...
            >
              ...
              <option value="target_date" className="bg-[#171C27] text-white">Sort: Target Date</option>
              <option value="progress" className="bg-[#171C27] text-white">Sort: Progress (High to Low)</option>
              <option value="priority" className="bg-[#171C27] text-white">Sort: Priority</option>
              <option value="alphabetical" className="bg-[#171C27] text-white">Sort: Alphabetical (A–Z)</option>
            </select>
          </div>
      ...
      <div className="flex flex-wrap items-center gap-2.5 pt-1 border-t border-white/[0.06]">
        ...
        <select
          ...
          className="px-3 py-1.5 text-xs bg-[#171C27] hover:bg-[#1f2635] text-slate-200 rounded-lg border border-white/[0.08] focus:border-[#7C3AED] focus:outline-none transition-colors cursor-pointer"
        >
          <option value="all" className="bg-[#171C27] text-white">Priority: All</option>
          <option value="high" className="bg-[#171C27] text-white">Priority: High</option>
          <option value="medium" className="bg-[#171C27] text-white">Priority: Medium</option>
          <option value="low" className="bg-[#171C27] text-white">Priority: Low</option>
        </select>
      </div>
    </div>
  );
