...
import { FileText, Pin, Archive } from 'lucide-react';

export default function NotesTabs({ activeTab, setActiveTab }) {
  ...
  const tabs = [
    {
      id: 'all',
      label: 'All Notes',
      count: metrics.activeNotesCount,
      icon: FileText,
    },
    {
      id: 'pinned',
      label: 'Pinned',
      count: metrics.pinnedNotesCount,
      icon: Pin,
    },
    {
      id: 'archived',
      label: 'Archived',
      count: metrics.archivedNotesCount,
      icon: Archive,
    },
  ];
